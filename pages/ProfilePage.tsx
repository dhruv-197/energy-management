        ...
        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="space-y-4">
                 <div>
                    ...
                    <input type="password" placeholder="••••••••" className="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500" />
                </div>
                 <div>
            ...
            <button className="mt-6 px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-md text-sm font-medium">Save Changes</button>
        </div>
      </Card>
    </div>
  );
