            ...
            <div>
                <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Emissions Unit</label>
                 <div className="flex items-center p-1 rounded-full bg-gray-200 dark:bg-gray-700">
                    <button onClick={() => setEmissionsUnit('kg')} className={`w-full px-2 py-1 text-xs font-medium rounded-full transition-colors ${emissionsUnit === 'kg' ? 'bg-white dark:bg-gray-900 text-violet-600 shadow-sm' : 'text-gray-500 dark:text-gray-400'}`}>kg CO₂</button>
                    <button onClick={() => setEmissionsUnit('t')} className={`w-full px-2 py-1 text-xs font-medium rounded-full transition-colors ${emissionsUnit === 't' ? 'bg-white dark:bg-gray-900 text-violet-600 shadow-sm' : 'text-gray-500 dark:text-gray-400'}`}>Tonnes</button>
                </div>
            </div>
