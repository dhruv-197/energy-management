      ...
      <Card title="Localization">
       ...
       <Card title="API Keys">
          <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={openModal} className="flex items-center px-3 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-md text-sm font-medium">
        ...
        {!generatedKey ? (
            <div>
                ...
                <input
                    ...
                    className="mt-1 block w-full px-3 py-2 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-violet-500 focus:border-violet-500"
                />
                <button onClick={handleGenerateKey} disabled={!newKeyName.trim()} className="mt-4 w-full flex items-center justify-center px-4 py-2 bg-violet-600 hover:bg-violet-700 text-white rounded-md font-semibold disabled:bg-violet-800">
                    Generate Key
                </button>
            </div>
        ) : (
